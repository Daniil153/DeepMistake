...
OUTPUT_DIR=xlmr-large..data_train-wic..train_loss-crossentropy_loss..data_ft-rusemshift..ft_loss-mse_loss..targ_emb-${targ_emb}..bn-1..pool-${pool}..ckpt-${train_ckpt}
...
python mcl-wic/run_model.py --do_train --do_validation --train_scd --data_dir mcl-wic/data_dumped_full/rusemshift-data/mean --output_dir $OUTPUT_DIR/finetune/ --gradient_accumulation_steps 16 \
	--pool_type $pool --target_embeddings $targ_emb --head_batchnorm 1 --loss mse_loss --linear_head $linhead \
